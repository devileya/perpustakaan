...
<!--                                  <input type="text" name="no_klas" class="form-control" placeholder="Nomor Klasifikasi" required="">-->
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" id="nama_klasifikasi" name="nama_klasifikasi" class="form-control" placeholder="Nama Klasifikasi" required="">
                                  </div>

                                <div class="form-group">
                                  <label>Sinopsis :</label>
                                  <input type="text" name="sinopsis" class="form-control" placeholder="Sinopsis" required="">
                                </div>
